...
description: Common issues and solutions when using Polterbase, plus security notes.
---
...
Polterbase forwards execution to Supabase CLI. Use `--debug` and re-run the command to inspect detailed logs.
