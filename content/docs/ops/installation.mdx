---
title: Installation
description: Install Ops from source or as a packaged macOS app, and understand what Polterbase configures for each path.
---
...
For a pinned build, use `npx @polterware/polterbase@latest app install ops --version <version>`.
...
Polterbase is the recommended workflow manager for Ops Supabase operations. It is the layer that wraps setup, link, migrate, configure, and install in a way that is specific to Ops.
</Callout>

## What Polterbase installs and configures
