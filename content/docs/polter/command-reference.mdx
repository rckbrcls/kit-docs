...
description: Complete reference of Supabase CLI commands available through the Polter interactive board.
---
...
```bash
npm install -g @polterware/polter@latest    # global
npm install -D @polterware/polter@latest     # repository
```
